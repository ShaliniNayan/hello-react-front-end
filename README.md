...
```sh
  cd my-folder
  git clone git@github.com:ShaliniNayan/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/ShaliniNayan/hello-react-front-end/issues).
